...
import banner2 from '../assets/bannerr/nawban1.png';
import banner3 from '../assets/bannerr/newban2.jpg';
import banner4 from '../assets/bannerr/newban3.png';
    ...
    <section className="w-full bg-white font-urbanist">
      <div className="w-full flex flex-col gap-[10px]">
        ...
        {banners.map((banner, index) => (
          <div 
            key={banner.id} 
            className="relative w-full h-[800px] md:h-[950px] overflow-hidden group border-b border-slate-100"
          >
            {/* Background Image */}
            <img 
              src={banner.image} 
            ...
            {/* Overlay */}
            <div 
              className={`absolute inset-0 flex items-center px-6 md:px-24 bg-black/10 
